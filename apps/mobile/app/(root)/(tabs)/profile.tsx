...
export default function ProfileScreen() {
  ...
  const fetchData = async () => {
    setIsLoading(true);
    try {
      const [profileRes, photosRes, myInterestsRes, allInterestsRes] =
        await Promise.all([
          getMyProfile(),
          getMyPhotos(),
          getMyInterests(),
        ...
        >
              ...
              {editingMode ? (
                <>
                  <TextInput
                    ...
                    style={{
                      color: themeColors.textPrimary,
                      borderColor: themeColors.textPrimary + "20",
                    }}
                  />
                  <TouchableOpacity
                ...
                <Text className="text-3xl font-bold text-textPrimaryLight dark:text-textPrimaryDark">
                  {nameInput},{" "}
                  <Text className="font-regular opacity-60">{age}</Text>
                </Text>
              )}
            </View>
          </View>
          ...
          <View className="mb-8">
            ...
            {editingMode ? (
              <TextInput
                ...
                style={{
                  color: themeColors.textPrimary,
                  backgroundColor: themeColors.textPrimary + "05",
                }}
              />
            ) : (
              <View>
          ...
          <View className="mb-8">
            ...
            <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 12 }}>
              {(editingMode ? editInterests : userInterests).map(
                (interest, idx) => (
                  <View
                  ...
                  >
                    ...
                    {editingMode && (
                      <TouchableOpacity
                        onPress={() => toggleEditInterest(interest)}
                      >
                        <AntDesign
                          name="close"
                          size={16}
              ...
              {editingMode && (
                <TouchableOpacity
                  ...
                  style={{
                    borderColor: themeColors.textPrimary + "40",
                ...
                >
                  ...
                  <Text
                    ...
                    style={{ color: themeColors.textPrimary, opacity: 0.6 }}
                  >
                    Add
                  </Text>
                </TouchableOpacity>
          ...
          <View>
            ...
            >
              {Array.from({ length: MAX_PHOTOS }).map((_, index) => {
                const photoUri =
                  uploads[index]?.uri ?? photos[index]?.image_url;
                  ...
                  >
                    <TouchableOpacity
                      ...
                      style={{
                        ...
                        borderColor:
                          isEmpty && editingMode
                            ? themeColors.textPrimary + "20"
                            : "transparent",
                        borderStyle:
                          isEmpty && editingMode ? "dashed" : "solid",
                        backgroundColor: isEmpty
                          ? "transparent"
                          : themeColors.textPrimary + "05",
                      }}
                    >
                      {!isEmpty ? (
                        <Image
