/**
 * This is the main wrapper for the mobile app.
 *
 * It loads fonts, sets the light/dark theme, and sets up
 * the authentication and data providers that the rest of the app uses.
 */
import "@/global.css";
